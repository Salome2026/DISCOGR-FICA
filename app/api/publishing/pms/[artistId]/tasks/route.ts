...
import { createPendingTask, listTasksForArtist } from "@/lib/db/publishingPendingTasks";
...
function canSeeArtist(roles: string[]): boolean {
  return roles.includes("editorial") || roles.includes("management") || roles.includes("admin");
}
