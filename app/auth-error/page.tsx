    ...
    <div className="ae-root bg-atmosphere">
      <style>{`
        ...
        .ae-panel{
          ...
          -webkit-backdrop-filter:blur(var(--glass-blur-strong)) saturate(1.7);
        ...
        .ae-link{display:inline-block;background:var(--accent-glass-bg);border:1px solid var(--accent-glass-border);color:var(--text-1);border-radius:10px;padding:10px 20px;font-weight:600;font-size:13.5px;text-decoration:none;backdrop-filter:blur(var(--glass-blur)) saturate(1.7);-webkit-backdrop-filter:blur(var(--glass-blur)) saturate(1.7);box-shadow:var(--shadow-glass);}
      `}</style>
