  ...
  return (
    <div className="nuevo-root">
      <style>{`
        ...
        .nuevo-panel{background:var(--glass-bg);border:1px solid var(--glass-border);border-radius:var(--radius-lg);padding:2rem;backdrop-filter:blur(var(--glass-blur)) saturate(1.7);-webkit-backdrop-filter:blur(var(--glass-blur)) saturate(1.7);box-shadow:var(--shadow-glass);}
        ...
        .nuevo-field input:focus, .nuevo-field select:focus, .nuevo-field textarea:focus{outline:none;border-color:var(--accent-color);}
