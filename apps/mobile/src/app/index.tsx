  ...
  return (
    <View style={styles.root}>
      ...
      {user.role === "tourmanager" ? (
        ...
        <Pressable style={styles.moduleButton} onPress={() => router.push("/management")}>
          <Text style={styles.moduleButtonText}>Ir a Management</Text>
        </Pressable>
      ) : user.role === "editorial" ? (
        ...
        <Pressable style={styles.moduleButton} onPress={() => router.push("/dashboard")}>
          <Text style={styles.moduleButtonText}>Ir al Dashboard</Text>
        </Pressable>
      ) : (
